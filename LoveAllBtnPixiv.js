...
(function () {
  ...
  var handle = setInterval(() => {
    ...
    justify-content: center;">
            <svg viewBox="0 0 32 32" width="32" height="32" class="sc-j89e3c-1 bXjFLc">
            <path d="
...
C26,9.73857625 23.7614237,7.5 21,7.5 C18.9508494,7.5 16.9142799,9.28334665 16,11.3317089 Z" class="sc-j89e3c-0 dUurgf">
</path></svg>
          </button>
        </li>`
      );
